...
조회 성능 최적화가 중요한 환경이었습니다.

---

# ⚙️ Key Responsibilities

플랫폼 핵심 도메인 API 설계 및 구현을 담당했습니다.

* 매물 요청 등록 / 수정 / 조회 API 개발
* 매물 내놓기 등록 / 수정 / 조회 / 삭제 기능 구현
* 사용자 알림 기능 (서비스 알림, 방해금지 시간 설정)
* 중개사 영업 리스트 관리 기능 개발
* 관리자 매물 / 회원 관리 API 구현
...
**문제**
관리자 매물 조회 API에서 다중 서브쿼리 사용으로 조회 성능 저하 발생

**원인**
조건별 필터링을 위해 서브쿼리가 중첩된 쿼리 구조 사용
...
* QueryDSL 기반 쿼리 최적화로 **DB 조회 성능 약 30% 개선**
* 관리자 조회 API **응답 속도 약 400ms 단축**
